...
public class RaymarchCamera : SceneViewFilter
{
    ...
    private void SetParameters()
    {
        ...
        _raymarchMaterial.SetMatrix("_CamFrustrum", CamFrustrum(camera));
        _raymarchMaterial.SetMatrix("_CamToWorld", camera.cameraToWorldMatrix);
        ...
        _raymarchMaterial.SetVector("_player", player ? player.position : Vector3.zero);
